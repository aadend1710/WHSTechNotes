...
I have multiple careers that I am very interested in such as film making and photography/videography and I believe that computer science and be used in both of these. I think that computer science can be used in photography, videography and film making since they are somewhat the same thing, using cameras that you can use computer science to enhance and reproduce photos/videos. Alongside that, computer science can also be used by creating computer-generated imagery (also known as CGI) for special effects, animation, and virtual sets through technologies like motion capture and rendering softwares.
